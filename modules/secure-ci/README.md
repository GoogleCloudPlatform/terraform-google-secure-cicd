...
This module creates a secure Continuous Integration (CI) pipeline using Google Cloud Build and Artifact Registry. It facilitates a software build process with built-in security checks, supporting 2nd-gen Cloud Build connections for GitHub and GitLab.
...
* **Source Code Repositories**: Supports 2nd-gen Cloud Build repository connections for GitHub and GitLab.
...
module "ci_pipeline" {
  ...
  github_auth = {
    secret_id         = "projects/my-secrets-project/secrets/github-pat"
    app_id_secret_id  = "projects/my-secrets-project/secrets/github-app-id"
...
| cache\_bucket\_name | Name of cloudbuild artifact and cache GCS bucket | `string` | `"bkt-cloudbuild"` | no |
