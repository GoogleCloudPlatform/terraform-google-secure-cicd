...
locals {
  deploy_branch_clusters = {
    "01-${var.env1_name}" = {
      ...
      project_id            = local.env_projects[var.env1_name].project_id
      location              = var.region
    ...
    "02-${var.env2_name}" = {
      ...
      project_id            = local.env_projects[var.env2_name].project_id
      location              = var.region
    ...
    "03-${var.env3_name}" = {
      ...
      project_id            = local.env_projects[var.env3_name].project_id
      location              = var.region
...
module "cloudbuild_private_pool" {
  ...
  network_project_id        = var.management_project_id
  location                  = var.region
